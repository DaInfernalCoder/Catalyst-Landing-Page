...
export const desktopParagraphPhrase = [
  ...
  'your first club with real founder mentorship.',
];
...
export const edges = [
  {
    ...
    details:
      'Learn from real founders, VCs, and club operators including Y Combinator alumni who share practical insights and industry knowledge.',
    icon: ic_document_duplicate,
  },
  {
    point: 'Hands-On Curriculum',
    details:
      'Follow our structured yearlong program: Discover & Define problems in Semester 1, then Build & Pitch your club in Semester 2.',
